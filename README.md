...
Enter the ~/.bashrc file: `nano ~/.bashrc`

Scroll down to the bottom. Directly above the line: `source ~/osu-uwrt/riptide_software/devel/setup.bash`
add the following line: `source ~/osu-uwrt/control_tooolbox/devel_isolated/setup.bash`
